...
compatibility: Requires Python 3.11+, the kaggle CLI, the kaggle-benchmarks SDK, and valid Kaggle credentials.
metadata:
  author: kaggle
  version: "0.2"
---
...
- `MODEL_PROXY_URL`, `MODEL_PROXY_API_KEY`, `MODEL_PROXY_EXPIRY_TIME`
- `LLM_DEFAULT`, `LLM_DEFAULT_EVAL`, `LLMS_AVAILABLE`
...
- **Upstream CLI long-form reference** — https://github.com/Kaggle/kaggle-cli/blob/main/skills/references/benchmarks.md  
  Load when you want the older, more verbose CLI reference (kept for historical detail).
